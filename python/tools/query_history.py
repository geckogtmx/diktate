...
def main():
    parser = argparse.ArgumentParser(description="Query dIKtate history database")

    parser.add_argument("--stats", action="store_true", help="Show overall statistics")
    parser.add_argument("--search", type=str, help="Search for phrase in history")
    parser.add_argument("--errors", action="store_true", help="Show error sessions")
    parser.add_argument(
        "--mode",
        type=str,
    ...
    parser.add_argument("--recent", type=int, metavar="N", help="Show N most recent sessions")
    parser.add_argument(
        "--db", type=str, help="Custom database path (default: ~/.diktate/history.db)"
    )
