...
const settingsAPI = {
  ...
  getDefaultPrompt: (mode: string, model: string) =>
    ipcRenderer.invoke('settings:get-default-prompt', mode, model),
  saveCustomPrompt: (mode: string, promptText: string) =>
    ipcRenderer.invoke('settings:save-custom-prompt', mode, promptText),
